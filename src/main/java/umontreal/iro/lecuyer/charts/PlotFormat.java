...
/**
 * Provide tools to import and export data set tables to and from Gnuplot, MATLAB and Mathematica compatible formats, or
 * customized format.
 *
 */
public class PlotFormat {
    ...
    /**
     * Parses {@code data} according to the standard GNUPlot format and stores the extracted values in the returned
     * table. All unrecognized characters and empty lines will be cut. Deleting comments inside the input {@code String}
     * is recommended.
     *
     * @param data String to parse.
     *
     * @return Table that represent data contained in {@code data}.
     * @exception IllegalArgumentException if each line of the input {@code String} doesn't share the same number of
     * values
     *
     *
     */
    ...
    /**
     * Parses {@code data} according to the standard CSV format and stores the extracted values in the returned table.
     *
     * @param data String to parse.
     *
     * @return Table that represent data contained in {@code data}.
    ...
    /**
     * Parses {@code data} according to a user defined format and stores the extracted values in the returned table.
     * <TT>betweenValues</TT> sets characters between values on the same line and <TT>endLine</TT> sets characters which
     * separates each line of the input data set. Usually, this parameter contains the classic end of line character
     * <TT>%n</TT>. This method uses regular expressions, so it is possible to use regular characters as defined in the
     * standard java API, specially in the class {@link Pattern} (package java.util.regex).
     *
     * @param betweenValues {@code String} which separates values on the same line.
     *
     * @param endLine {@code String} which separates lines.
     *
     * @param data String to parse.
     *
     * @return Table that represent data contained in {@code data}.
    ...
    /**
     * Stores data tables {@code data} into a {@code String}, with format understandable by GNUPlot.
     *
    ...
    /**
     * Stores series collection {@code data} into a {@code String}, with format understandable by GNUPlot.
     *
     * @param data data tables.
     *
     * @return String that represent data tables in GNUPlot format.
    ...
    /**
     * Stores data tables {@code data} into a {@code String} with format CSV (comma-separated value tabular data). The
     * output string could be imported from a file to a matrix into Mathematica with Mathematica's function
     * <TT>Import["fileName", "CSV"]</TT>, or into MATLAB with MATLAB's function <TT>csvread('fileName')</TT>.
     *
     * @param data data tables.
     *
    ...
    /**
     * Stores series collection {@code data} into a {@code String} with format CSV (comma-separated value tabular data).
     *
     * @param data data tables.
     *
     * @return String that represent data tables in CSV format.
    ...
    /**
     * Stores data tables {@code data} into a {@code String} with customized format. <TT>heading</TT> sets the head of
     * the returned {@code String}, <TT>footer</TT> sets its end, <TT>betweenValues</TT> sets characters between values
     * on the same line and finally <TT>endLine</TT> sets characters which separates each line of the input data set.
     * Normally, this parameter contains the classic end of line character `%n'.
     *
     * @param heading head of the returned {@code String}.
     *
     * @param footer end of the returned {@code String}.
     *
     * @param betweenValues {@code String} which separates values on the same line.
     *
     * @param endLine {@code String} which separates lines.
    ...
    /**
     * Stores data tables {@code data} into a {@code String} with customized format from an <TT>XYSeriesCollection</TT>
     * variable.
     *
     * @param heading head of the returned {@code String}.
     *
